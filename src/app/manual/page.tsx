                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-0.5">
                                ...
                                <span className="font-mono text-[9px] text-slate-400 tracking-widest">REV. 2.2.0</span>
                            </div>
                ...
                <div className="flex flex-col md:flex-row">
                    ...
                    <main className="flex-1 p-4 md:p-10 space-y-14 min-w-0 print:p-4">
                                ...
                                <table className="w-full text-sm border-collapse">
                                    <thead>
                                        <tr className="bg-blue-700 text-white text-xs">
                                            <th className="px-3 py-2 border border-blue-600 text-left w-32">用語</th>
                                    ...
                                    <tbody>
                                        {[
                                            ...
                                            ["p（パック）", "製品の販売単位（2個入り等）。棚卸・出荷時にケース未満の端数として入力します。"],
                            ...
                            <div className="space-y-3">
                                <InfoBox color="amber" icon={<AlertCircle className="h-4 w-4 shrink-0" />} title="重要：在庫との連動ルール">
                                    ...
                                    <ul className="list-disc pl-4 mt-2 space-y-1">
                                        <li>「入荷済にする」ボタン → 原料在庫 <span className="text-green-700 font-bold">＋加算</span></li>
                                        <li>「製造開始」ボタン → 原料在庫 <span className="text-red-600 font-bold">－減算</span></li>
                                        <li>「製造完了・実績入力」→ キープサンプル自動登録 ＋ 製品在庫 <span className="text-green-700 font-bold">＋加算</span></li>
                                        <li>「出荷確定」ボタン → 製品在庫 <span className="text-red-600 font-bold">－減算</span>（0になった Lot は自動削除）</li>
                                        <li>「計画削除（キャンセル）」→ 連動した在庫変動を<span className="text-blue-700 font-bold">自動でロールバック</span></li>
                                    </ul>
                        ...
                        <section id="master" className="avoid-break scroll-mt-20">
                            ...
                            <SubTitle>■ 新規データの登録</SubTitle>
                            <div className="space-y-2 text-sm mb-4">
                                <StepBadge n={1} label='画面右上の「新規データ登録」ボタンを押します。' />
                                <StepBadge n={2} label='現在開いているタブ（例：品目マスタ）に合わせた登録フォームが開きます。' />
                                <StepBadge n={3} label='必要項目を入力して「保存」を押します。' />
                            </div>

                            <SubTitle>■ 既存データの編集方法</SubTitle>
                            <div className="space-y-2 text-sm mb-4">
                                <StepBadge n={1} label='一覧表の編集したいセル（文字）を直接クリックします。入力枠に変わります。' />
                                <StepBadge n={2} label='値を書き換えて Enter キーを押すだけで上書き保存されます。' />
                            </div>
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full text-xs border-collapse">
                                    ...
                                    <tbody className="text-slate-600">
                                        {[
                                            ["製品マスタ", "製品名 / 種類(味) / 1kgあたり個数 / 1c/sあたり入数(unit_per_cs)", "unit_per_cs を間違えると在庫計算が狂う。変更時は必ず棚卸を実施。"],
                        ...
                        <section id="order" className="avoid-break scroll-mt-20">
                            ...
                            <div className="space-y-2 text-sm mb-4">
                                ...
                                <StepBadge n={2} label='以下の基本情報を入力します：' />
                                <div className="ml-9 bg-slate-50 border border-slate-200 rounded-lg p-4 space-y-2">
                                    {[
                                        ...
                                        <div key={field as string} className="flex items-start gap-2 text-sm">
                                            <span className="font-bold text-blue-800 shrink-0 w-24">{field as string}</span>
                                ...
                                <StepBadge n={3} label='製品と数量を入力します。1枚の注文書に複数の味がある場合は「製品を追加する」ボタンで行を追加し、まとめて登録できます。数量は c/s とパック(p) の両方で入力可能です。' />
                                <StepBadge n={4} label='数量を入力した瞬間、BOMシミュレーション結果が右側に表示されます。不足がある場合は赤色で警告が出ます。' />
                                <StepBadge n={5} label='BOM 確認後、「受注を確定する」ボタンを押して保存します。' />
                            </div>
                            ...
                            <div className="bg-slate-50 border border-slate-200 rounded-lg p-4 space-y-2 text-sm">
                                ...
                                <div className="flex items-start gap-2">
                                    ...
                                    <p><strong>キャンセル（削除）：</strong>「キャンセル」ボタンを押すと受注が取り消されます。製造計画が紐づいている場合は先に計画を削除してください。</p>
                                </div>
                            </div>
                            ...
                            <div className="mt-4 grid sm:grid-cols-2 gap-3">
                                ...
                                <InfoBox color="red" icon={<AlertTriangle className="h-4 w-4" />} title="在庫が不足している場合">
                                    不足品目が<span className="font-bold text-red-700">赤色</span>で警告表示されます。受注登録は可能ですが、製造前に<strong>入荷管理</strong>で調達してください。
                                </InfoBox>
                            </div>
                        </section>
                        ...
                        <section id="production" className="avoid-break scroll-mt-20">
                            ...
                            <div className="space-y-2 text-sm mb-4">
                                ...
                                <StepBadge n={2} label='左側「未計画の残数がある受注」リストから、製造したい受注をクリックします。受注がない場合は右上の「見込み生産」ボタンを使用します。' />
                            ...
                            <div className="space-y-2 text-sm mb-4">
                                ...
                                <StepBadge n={4} label='パンが完成したら：「製造を完了し、実績数を入力」ボタンを押します。' />
                                <StepBadge n={5} label='実際の完成数（ケース数 / パック数）を入力して確定します。' />
                                <div className="ml-9">
                                    <InfoBox color="green" icon={<CheckCircle2 className="h-4 w-4" />} title="2つの処理が自動で行われます">
                                        <ol className="list-decimal pl-4 space-y-1">
                                            <li><strong>キープサンプル自動登録：</strong>キープサンプル分の数が自動で引かれ、「キープサンプル管理」に Lot 番号付きで登録されます。</li>
                            ...
                            <InfoBox color="red" icon={<AlertCircle className="h-4 w-4" />} title="間違えても安心：自動ロールバック機能">
                                ...
                                <p className="mt-2 text-xs">いずれの処理も inventory_adjustments テーブルに「ロールバックによる調整」として証跡が残ります。</p>
                            </InfoBox>
                        ...
                        <section id="inventory" className="avoid-break scroll-mt-20">
                            ...
                            <ul className="list-disc pl-5 space-y-2 text-sm text-slate-700 mb-4">
                                ...
                                <li>計算式：<code className="bg-slate-100 px-1 rounded text-xs">翌日在庫 ＝ 本日在庫 ＋ 入荷予定数 − 製造予定のBOM消費量</code></li>
                            </ul>

                            <SubTitle>■ 既存 Lot の追加登録</SubTitle>
                            <p className="text-sm text-slate-700 mb-4">
                                システム導入前（過去）に製造された在庫をシステムに登録したい場合は、画面右上の「既存Lotの追加登録」ボタンから Lot 番号・賞味期限・数量を手動で追加できます。
                            </p>
                            ...
                            <div className="space-y-2 text-sm mb-4">
                                ...
                                <StepBadge n={3} label='製品在庫はケース (c/s) とパック (p) を別々の枠に入力できます。' />
                                <StepBadge n={4} label='変更した項目は黄色くハイライトされます。内容を確認したら「一括で上書き保存」ボタンを押します。' />
                                <StepBadge n={5} label='調整履歴（変更前・変更後・差分・日時）が inventory_adjustments テーブルに自動記録されます。' />
                            </div>

                            <SubTitle>■ 在庫表（PDF）の印刷</SubTitle>
                            <p className="text-sm text-slate-700 mb-3">
                                実地棚卸用に、空欄の「実数記入欄」が付いた在庫一覧表を PDF で印刷できます。画面右上の「在庫表(PDF)を印刷」ボタンを押してください。
                            </p>
                        ...
                        <section id="shipment" className="avoid-break scroll-mt-20">
                            ...
                            <div className="space-y-2 text-sm mb-4">
                                ...
                                <StepBadge n={2} label='左側リストから出荷する受注をクリックして選択します。同じ注文書の製品はまとめて表示されます。' />
                                ...
                                <StepBadge n={6} label='「出荷を確定」ボタンを押します。製品在庫が減算され、在庫が 0 になった Lot は自動的にデータが消去されます。' />
                            </div>

                            <SubTitle>■ 出荷管理票 PDF の作成</SubTitle>
                            <p className="text-sm text-slate-700 mb-4">
                                画面右上の「出荷実績から管理票(PDF)を作成」ボタンから、出荷済みの実績データを元にした「出荷管理票」を PDF で印刷できます。
                            </p>
                        ...
                        <section id="calendar" className="avoid-break scroll-mt-20">
                            ...
                            <p className="text-sm text-slate-600 mb-4">
                                製造管理および入荷管理画面にある「予定表（カレンダー）」は、工場全体のスケジュールボードとして活躍します。
                            </p>
                            ...
                            <div className="flex flex-wrap gap-2 text-xs font-bold mb-3">
                                {[
                                    ...
                                    { label: "出荷予定（紫）", color: "bg-purple-100 text-purple-800 border-purple-300" },
                            ...
                            <div className="space-y-2 text-sm">
                                ...
                                <StepBadge n={2} label='白黒印刷で綺麗にA4用紙に収まる専用レイアウトで印刷されます。' />
                            </div>
                        </section>
                        ...
                        <section id="errors" className="avoid-break scroll-mt-20">
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    { color: "amber" as const, msg: "出荷可能な Lot がありません", cause: "製品在庫に該当製品の Lot が存在しない。", action: "製造管理で「製造完了・実績入力」まで処理されているか確認してください。" },
                        ...
                        <section id="trouble" className="avoid-break scroll-mt-20">
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    { q: "キープサンプルが自動登録されない", a: "「製造完了・実績入力」ボタンを使用しているか確認してください。旧バージョンの「製造を完了する」ボタンではキープサンプルは登録されません。" },
                                    { q: "棚卸で保存したのに数値が元に戻った", a: "「一括で上書き保存」を押す前にブラウザがリロードされた可能性があります。保存後に調整履歴を確認してください。" },
                                    { q: "スマホでカレンダーがマス目表示になる", a: "スマホでは自動的に縦型リストカレンダーに切り替わります。ブラウザのズームを 100% に戻してください。" },
                ...
                <div className="flex flex-col md:flex-row">
                    ...
                    <main className="flex-1 p-4 md:p-10 space-y-12 min-w-0">
                            ...
                            <div className="grid sm:grid-cols-2 gap-4 text-sm">
                                <div className="border border-slate-200 rounded-lg p-4 bg-slate-50">
                                    ...
                                    <p className="text-slate-600 mb-2">
                                        <code className="bg-white px-1 rounded border text-xs">product_stocks.total_pieces</code> に<strong>総個数（ピース数）</strong>で保存
                                    </p>
                                ...
                                <div className="border border-slate-200 rounded-lg p-4 bg-slate-50">
                                    ...
                                    <p className="text-xs text-slate-500 mt-2">※ パックは2個入りのため ÷2 で変換します。</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="tech-05" className="scroll-mt-20">
                            <SectionTitle id="tech-05-h">05. ロールバック安全設計</SectionTitle>
                            <p className="text-sm text-slate-700 mb-3">
                                製造中・製造完了・出荷完了といった「一度在庫を動かしたデータ」を削除（キャンセル）した場合、システムは自動的に以下のように動作し、データの整合性を担保します。
                            </p>
                            <div className="border border-slate-200 rounded-lg overflow-hidden divide-y divide-slate-200 text-sm">
                                {[
                                    {
                                        trigger: "「製造中」の計画を削除",
                                        action: "使用予定だった原料・資材の item_stocks を元の数に加算（復元）する。",
                                        log: "inventory_adjustments に「ロールバック：原料復元」として記録。",
                                    },
                                    {
                                        trigger: "「完了済」の計画を削除",
                                        action: "完成した製品の product_stocks を減算し、0になったらレコードごと DELETE する。キープサンプル（keep_samples）も削除。",
                                        log: "inventory_adjustments に「ロールバック：製品取消」として記録。",
                                    },
                                    {
                                        trigger: "出荷確定後に在庫を戻したい場合",
                                        action: "出荷のロールバック機能はありません。棚卸（手動調整）で対応します。",
                                        log: "inventory_adjustments に「棚卸調整」として記録。",
                                    },
                                ].map((row) => (
                                    <div key={row.trigger} className="p-4">
                                        ...
                                        <div className="text-slate-500 text-xs">{row.log}</div>
                                    </div>
                                ))}
                            </div>
                        </section>
                        ...
                        <section id="tech-06" className="scroll-mt-20">
                            <SectionTitle id="tech-06-h">06. データベース・テーブル構成</SectionTitle>
