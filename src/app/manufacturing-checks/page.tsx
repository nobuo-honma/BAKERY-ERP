                        ...
                        <tbody>
                            ...
                            <tr className="bg-gray-50">
                                ...
                                {daysArray.map(day => {
                                    ...
                                    return <td key={day} className="border border-black text-center p-0">{checker ? <div className="text-[7px] truncate max-w-3.5 mx-auto leading-none pt-0.5">{checker.slice(0, 2)}</div> : ""}</td>;
                                })}
                            </tr>
                        </tbody>
                    </table>
